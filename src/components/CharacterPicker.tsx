...
export const availableCharacters: CharacterData[] = [
  ...
  { ...makeIcon("ann"), rarity: "superrare", name_en: "Ann Takamaki", name_ko: "타카마키 안미야시타 미나미", codename: "Panther", affinity: "Fire", id: 1191 },
...
export const availableWeapons: WeaponData[] = [
  ...
  { ...makeWeaponIcon("ryuji-5"), rarity: "superrare", name_en: "Revenge Axe", assChara: "Ryuji Sakamoto", id: 210104 },
  { ...makeWeaponIcon("ann-5"), rarity: "superrare", name_en: "Rosethorn", assChara: "Ann Takamaki", id: 211904 },
  { ...makeWeaponIcon("yaoling-5"), rarity: "superrare", name_en: "Infinite Moment", name_ko: "하늘의 일념", assChara: "Yaoling Li", id: 210904 },
  { ...makeWeaponIcon("haruna-5"), rarity: "superrare", name_en: "Sweet Pickaxe", assChara: "Haruna Nishimori", id: 212804 },
  { ...makeWeaponIcon("lufel-5"), rarity: "superrare", name_en: "Fallen Angel Wing", assChara: "Lufel", id: 210404 },
  { ...makeWeaponIcon("motoha-5"), rarity: "superrare", name_en: "Quasar", assChara: "Motoha Arai", id: 210304 },
  { ...makeWeaponIcon("shun-5"), rarity: "superrare", name_en: "Permafrost", assChara: "Shun Kano", id: 210604 },
  { ...makeWeaponIcon("leo-5"), rarity: "superrare", name_en: "Final Buster", name_ko: "디스트로이어 MR", assChara: "Leo Kamiyama", id: 210704},
  { ...makeWeaponIcon("kayo-5"), rarity: "superrare", name_en: "Retro Disco Style", assChara: "Kayo Tomiyama", id: 210804 },
  { ...makeWeaponIcon("tomoko-5"), rarity: "superrare", name_en: "Dream and Nightmare", assChara: "Tomoko Noge", id: 211004 },
  { ...makeWeaponIcon("kiyoshi-5"), rarity: "superrare", name_en: "Baptism by Fire", assChara: "Kiyoshi Kurotani", id: 211204 },
  { ...makeWeaponIcon("yukimi-5"), rarity: "superrare", name_en: "Karmic Cycle", name_ko: "퍼플 샐베이션", assChara: "Yukimi Fujikawa", id: 211304 },
  { ...makeWeaponIcon("seiji-5"), rarity: "superrare", name_en: "Venus Sunrise", name_ko: "계몽의 별", assChara: "Seiji Shiratori", id: 211404 },
  { ...makeWeaponIcon("toshiya-5"), rarity: "superrare", name_en: "Babel's Verdict", assChara: "Toshiya Sumi", id: 211804 },
  { ...makeWeaponIcon("kotone-5"), rarity: "superrare", name_en: "Queen of Winter", assChara: "Kotone Montagne", id: 212104 },
  { ...makeWeaponIcon("miyu-5"), rarity: "superrare", name_en: "Ephemerality", assChara: "Miyu Sahara", id: 212704 },
  ...
  { ...makeWeaponIcon("haruna-4"),rarity: "rare", name_en: "Chirpy Pickaxe", assChara: "Haruna Nishimori", id: 212803 },
  ...
  { ...makeWeaponIcon("toshiya-4"),rarity: "rare", name_en: "Scarlet Scepter", name_ko: "킬링 스칼렛", assChara: "Toshiya Sumi", id: 211803 },
  ...
  { ...makeWeaponIcon("riko-4"),rarity: "rare", name_en: "Moonlight Needle", assChara: "Riko Tanemura", id: 210503 },
  ...
  { src: "NULL", modalsrc: "NULL", collectionsrc: "NULL", rarity: "standard", name_en: "Amped-Up Guitar Axe", assChara: "Ayaka Sakai",  id: 213202},
