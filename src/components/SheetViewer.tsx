...
import { getAccessToken } from "@/utils/google.ts";
                                    ...
                                    <div className="flex items-center justify-between w-full">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <Dialog open={dialogOpen} onOpenChange={(open) => {
                                                ...
                                                {/* This is the dialog content that adds new data to the spreadsheet */}
                                                <DialogContent
                                                    className="w-full sm:max-w-7xl bg-cover overflow-visible pt-25 pb-10 border-4 shadow-none"
                                                ...
                                                >
                                                    ...
                                                    {/* Pillar Layout */}
                                                    <div className="flex justify-center gap-4 py-6 px-4 overflow-visible">
